...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterUncreatableType<DebInstaller>("Long.DebInstaller", 1, 0,
                                             "DebInstaller", "error");

    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/long-debinstaller/translations/").arg(locale.name());
    ...
    qmlRegisterUncreatableType<DebInstaller>("Long.DebInstaller", 1, 0, "DebInstaller", "error");
